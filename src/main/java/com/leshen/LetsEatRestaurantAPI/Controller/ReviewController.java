...
public class ReviewController {
    ...
    public ResponseEntity<List<ReviewDto>> getReviewsForRestaurant(@Parameter(description="Identifier of the restaurant") @PathVariable Long restaurantId) {
    ...
    @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content)
    public ResponseEntity<ReviewDto> getById(@Parameter(description="Identifier of the review") @PathVariable long id) {
